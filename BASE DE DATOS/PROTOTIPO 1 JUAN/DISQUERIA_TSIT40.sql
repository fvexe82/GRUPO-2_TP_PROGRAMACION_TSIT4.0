...
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/2e4nwiX8ZCU09LGLOpeqTH' WHERE `id_interprete`='1';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/1Tx3YSK3DFC4cYHXqOUb2u' WHERE `id_interprete`='2';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/0h885xmyK9xHfhyXQr37L6' WHERE `id_interprete`='3';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/5Cdrxi7EPRhVJs37sMRyNF' WHERE `id_interprete`='4';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/4P70aqttdpJ9vuYFDmf7f6' WHERE `id_interprete`='5';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/5MhLmv7GgyjbxGqiIGasvT' WHERE `id_interprete`='6';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/playlist/37i9dQZF1E4qRaNqXSF2g4' WHERE `id_interprete`='7';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/1GlOpg3dPUft550esb82K3' WHERE `id_interprete`='8';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/7E7CVSqFdLyh0K4AE9uTMo' WHERE `id_interprete`='9';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/7E7CVSqFdLyh0K4AE9uTMo' WHERE `id_interprete`='10';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/playlist/37i9dQZF1DZ06evO1BjbKA' WHERE `id_interprete`='11';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/05Q9xndTxhXhD5trpmTtfU' WHERE `id_interprete`='12';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/7dsugSamBB7enWE2IrlbFg' WHERE `id_interprete`='13';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/3fMbdgg4jU18AjLCKBhRSm' WHERE `id_interprete`='14';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/2nszmSgqreHSdJA3zWPyrW' WHERE `id_interprete`='15';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/5RwfJb8wxN1fuodcPORVxP' WHERE `id_interprete`='16';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/4etuCZVdP8yiNPn4xf0ie5' WHERE `id_interprete`='17';
UPDATE `disqueria`.`interprete` SET `foto`='https://open.spotify.com/artist/5ttV0N9HvMH3KLqNKcS2M0' WHERE `id_interprete`='18';
